namespace FontConvert
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(5, 220);
			this.button1.Name = "button1";
			this.button1.Size = new System.Drawing.Size(79, 23);
			this.button1.TabIndex = 0;
			this.button1.Text = "转繁体";
			...
			this.textBox1.Size = new System.Drawing.Size(253, 211);
			...
			this.button4.Text = "添加报表默认字体和大小";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(5, 249);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(149, 23);
			this.button5.TabIndex = 5;
			this.button5.Text = "报表字体调小1px";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.button5_Click);
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(160, 249);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(149, 23);
			this.button6.TabIndex = 6;
			this.button6.Text = "递归目录下所有文件";
